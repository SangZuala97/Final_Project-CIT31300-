...
const Contact = () => {
    ...
    return (
        <section class="bg-[#F6F6F4] text-gray-600 body-font">
            ...
            <div class="grid grid-cols-1 gap-12 mt-10 lg:grid-cols-2">
                <div class="grid grid-cols-1 gap-12 md:grid-cols-2">
                    <div>
                        ...
                        <p class="mt-2 text-sm text-blue-500 dark:text-blue-400">hello123@gmail.com</p>
                    </div>
                    ...
                    <div>
                        ...
                        <p class="mt-2 text-sm text-blue-500 dark:text-blue-400">123 Indiana Ave, indianapolis,IN</p>
                    </div>
